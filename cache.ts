...
const teamsCache: Team[] = [
  {
    ...
    weeklyResults: [
      ...
      },
      {
        weekId: 2,
        bench: [
          { name: 'Carson Wentz', position: 1, total: 12.52 },
          { name: 'Laviska Shenault Jr.', position: 3, total: 10.94 },
          { name: 'T.J. Hockenson', position: 4, total: 10.2 },
          { name: 'Davante Adams', position: 3, total: 6.6 },
          { name: 'Chase Edmonds', position: 2, total: 3.38 },
          { name: 'Tyrod Taylor', position: 1, total: 0 },
          { name: 'Latavius Murray', position: 2, total: 0 },
        ],
        startingTotal: 202.88,
        benchTotal: 43.64,
        qb: { name: 'Dak Prescott', position: 1, total: 40.16 },
        superFlex: { name: 'Kyler Murray', position: 1, total: 33.48 },
        wr1: { name: 'Calvin Ridley', position: 3, total: 29.9 },
        te: { name: 'Mike Gesicki', position: 4, total: 27 },
        wr2: { name: 'Terry McLaurin', position: 3, total: 25.5 },
        wr3: { name: 'DeVante Parker', position: 3, total: 16.3 },
        flex: { name: 'DeSean Jackson', position: 3, total: 12.4 },
        rb1: { name: 'Derrick Henry', position: 2, total: 10.08 },
        rb2: { name: 'J.K. Dobbins', position: 2, total: 8.06 },
      },
    ],
  ...
  },
  {
    ...
    weeklyResults: [
      ...
      },
      {
        weekId: 2,
        bench: [
          { name: 'Daniel Jones', position: 1, total: 8.16 },
          { name: 'Tarik Cohen', position: 2, total: 3.94 },
          { name: 'Cam Akers', position: 2, total: 1.56 },
          { name: 'Henry Ruggs III', position: 3, total: 0 },
          { name: 'Chris Godwin', position: 3, total: 0 },
          { name: 'Michael Thomas', position: 3, total: 0 },
          { name: 'Mohamed Sanu Sr.', position: 3, total: 0 },
        ],
        startingTotal: 164.26000000000002,
        benchTotal: 13.66,
        wr1: { name: 'Stefon Diggs', position: 3, total: 29.3 },
        te: { name: 'Tyler Higbee', position: 4, total: 28.4 },
        qb: { name: 'Ryan Tannehill', position: 1, total: 27 },
        superFlex: {
          name: 'Jared Goff',
          position: 1,
          total: 24.240000000000002,
        },
        rb1: { name: 'Melvin Gordon III', position: 2, total: 17.8 },
        flex: { name: 'Hunter Henry', position: 4, total: 14.3 },
        wr2: { name: 'Quintez Cephus', position: 3, total: 8.4 },
        wr3: { name: 'Allen Lazard', position: 3, total: 7.5 },
        rb2: {
          name: 'Todd Gurley II',
          position: 2,
  ...
  },
  {
    ...
    weeklyResults: [
      ...
      },
      {
        weekId: 2,
        bench: [
          { name: 'Baker Mayfield', position: 1, total: 15.36 },
          { name: 'A.J. Green', position: 3, total: 5.9 },
          { name: 'Saquon Barkley', position: 2, total: 3.36 },
          { name: 'AJ Dillon', position: 2, total: 2.04 },
          { name: 'Will Fuller V', position: 3, total: 0 },
          { name: 'Anthony Miller', position: 3, total: 0 },
          { name: "Le'Veon Bell", position: 2, total: 0 },
        ],
        startingTotal: 166.26,
        benchTotal: 26.659999999999997,
        qb: { name: 'Josh Allen', position: 1, total: 34.84 },
        ...
        te: { name: 'Noah Fant', position: 4, total: 17.7 },
        superFlex: { name: 'Ben Roethlisberger', position: 1, total: 17.2 },
        wr1: { name: "N'Keal Harry", position: 3, total: 15.2 },
        flex: {
          name: 'Clyde Edwards-Helaire',
          position: 2,
          total: 13.759999999999998,
        },
        wr2: { name: 'DJ Chark Jr.', position: 3, total: 12.4 },
        wr3: {
          name: 'Darius Slayton',
          position: 3,
  ...
  },
  {
    ...
    weeklyResults: [
      ...
      },
      {
        weekId: 2,
        bench: [
          { name: 'T.Y. Hilton', position: 3, total: 5.800000000000001 },
          { name: 'Adrian Peterson', position: 2, total: 4.92 },
          { name: 'Brandon Aiyuk', position: 3, total: 4.1 },
          { name: 'Greg Olsen', position: 4, total: 0 },
          { name: 'Nick Foles', position: 1, total: 0 },
          { name: 'Hunter Renfrow', position: 3, total: 0 },
          { name: 'Jared Cook', position: 4, total: 0 },
        ],
        startingTotal: 157.18,
        benchTotal: 14.82,
        wr1: {
          name: 'Julian Edelman',
          position: 3,
        ...
        rb1: { name: 'Miles Sanders', position: 2, total: 22 },
        superFlex: {
          name: 'Aaron Rodgers',
          position: 1,
          total: 19.439999999999998,
        },
        rb2: { name: 'Dalvin Cook', position: 2, total: 18.36 },
        wr2: {
          name: 'Keenan Allen',
          position: 3,
          total: 15.600000000000001,
        },
        te: { name: 'Tyler Eifert', position: 4, total: 12.6 },
        wr3: { name: 'Robert Woods', position: 3, total: 11.68 },
        flex: { name: 'David Johnson', position: 2, total: 7.68 },
      },
    ],
  ...
  },
  {
    ...
    weeklyResults: [
      ...
      },
      {
        weekId: 2,
        bench: [
          { name: 'Tom Brady', position: 1, total: 8.68 },
          { name: 'Austin Hooper', position: 4, total: 4.2 },
          { name: 'Mike Williams', position: 3, total: 3.4000000000000004 },
          { name: 'Josh Jacobs', position: 2, total: 0 },
          { name: 'Marlon Mack', position: 2, total: 0 },
          { name: 'Jacoby Brissett', position: 1, total: 0 },
          { name: 'Rob Gronkowski', position: 4, total: 0 },
        ],
        startingTotal: 146.52,
        benchTotal: 16.28,
        ...
        qb: { name: 'Gardner Minshew II', position: 1, total: 22.84 },
        rb2: { name: 'Darrell Henderson Jr.', position: 2, total: 21.72 },
        wr2: {
          name: 'Cooper Kupp',
          position: 3,
          total: 13.379999999999999,
        },
        superFlex: { name: 'Sam Darnold', position: 1, total: 12 },
        te: { name: 'Zach Ertz', position: 4, total: 9.2 },
        wr3: {
          name: 'Michael Gallup',
          position: 3,
    ...
    weeklyResults: [
      ...
      },
      {
        ...
        bench: [
          ...
          { name: 'Chris Herndon', position: 4, total: 1.5 },
          { name: 'Nyheim Hines', position: 2, total: 1.4 },
          { name: 'Drew Brees', position: 1, total: 0 },
          { name: 'Phillip Lindsay', position: 2, total: 0 },
          { name: 'Emmanuel Sanders', position: 3, total: 0 },
          { name: 'Kenny Golladay', position: 3, total: 0 },
        ],
        startingTotal: 109.99999999999999,
        benchTotal: 14.78,
        te: { name: 'Travis Kelce', position: 4, total: 24 },
        qb: {
          name: 'Matthew Stafford',
          position: 1,
          total: 16.240000000000002,
        },
        wr1: { name: 'Amari Cooper', position: 3, total: 16 },
        rb1: { name: 'Joshua Kelley', position: 2, total: 14.58 },
        rb2: {
          name: 'Antonio Gibson',
          position: 2,
          total: 13.299999999999999,
        },
        superFlex: { name: 'Jimmy Garoppolo', position: 1, total: 13.24 },
        wr2: { name: 'Adam Thielen', position: 3, total: 6.1 },
        flex: { name: 'Zack Moss', position: 2, total: 4.4399999999999995 },
        wr3: { name: 'Sammy Watkins', position: 3, total: 2.1 },
      },
    ],
  ...
  },
  {
    ...
    weeklyResults: [
      ...
      },
      {
        weekId: 2,
        bench: [
          { name: 'Joe Mixon', position: 2, total: 13.52 },
          {
            name: 'Courtland Sutton',
            position: 3,
            total: 9.600000000000001,
          },
          { name: 'Parris Campbell', position: 3, total: 0.84 },
          { name: 'Peyton Barber', position: 2, total: 0.12 },
          { name: 'Deebo Samuel', position: 3, total: 0 },
          { name: 'A.J. Brown', position: 3, total: 0 },
          { name: 'Kirk Cousins', position: 1, total: -1.4799999999999995 },
        ],
        startingTotal: 162.34,
        benchTotal: 22.6,
        te: { name: 'Jonnu Smith', position: 4, total: 24.4 },
        rb1: { name: 'James Conner', position: 2, total: 22.22 },
        rb2: { name: 'Austin Ekeler', position: 2, total: 20.66 },
        flex: { name: 'Raheem Mostert', position: 2, total: 20.54 },
        wr1: { name: 'Tyler Boyd', position: 3, total: 20.2 },
        wr2: { name: 'Keelan Cole Sr.', position: 3, total: 17.8 },
        superFlex: { name: 'Jerick McKinnon', position: 2, total: 15.24 },
        wr3: { name: 'Corey Davis', position: 3, total: 12.6 },
        qb: { name: 'Teddy Bridgewater', position: 1, total: 8.68 },
      },
    ],
  ...
  },
  {
    ...
    weeklyResults: [
      ...
      },
      {
        weekId: 2,
        bench: [
          { name: 'Scotty Miller', position: 3, total: 3.22 },
          { name: 'Alvin Kamara', position: 2, total: 0 },
          { name: 'Duke Johnson', position: 2, total: 0 },
          { name: 'Alshon Jeffery', position: 3, total: 0 },
          { name: 'Taysom Hill', position: 4, total: 0 },
          { name: "Tre'Quan Smith", position: 3, total: 0 },
          { name: 'Drew Lock', position: 1, total: -1.2 },
        ],
        startingTotal: 118.7,
        benchTotal: 2.0200000000000005,
        qb: { name: 'Matt Ryan', position: 1, total: 28.840000000000003 },
        rb1: {
          name: 'Christian McCaffrey',
          position: 2,
          total: 25.979999999999997,
        },
        wr1: { name: 'John Brown', position: 3, total: 18.200000000000003 },
        wr2: { name: 'Robby Anderson', position: 3, total: 17.9 },
        wr3: { name: 'Christian Kirk', position: 3, total: 8.06 },
        flex: {
          name: 'Mecole Hardman',
          position: 3,
          total: 7.359999999999999,
        },
        superFlex: { name: 'Preston Williams', position: 3, total: 5.6 },
        te: {
          name: 'Mark Andrews',
          position: 4,
    ...
    weeklyResults: [
      ...
      },
      {
        ...
        bench: [
          ...
          { name: 'Matt Breida', position: 2, total: 4.64 },
          { name: 'Danny Amendola', position: 3, total: 4.1 },
          { name: 'Breshad Perriman', position: 3, total: 3.2 },
          { name: 'Jack Doyle', position: 4, total: 0 },
          { name: 'George Kittle', position: 4, total: 0 },
        ],
        startingTotal: 156.88,
        benchTotal: 27.8,
        qb: { name: 'Cam Newton', position: 1, total: 35.52 },
        superFlex: {
          name: 'Ryan Fitzpatrick',
          position: 1,
          total: 23.560000000000002,
        },
        rb1: { name: 'Ezekiel Elliott', position: 2, total: 22.98 },
        wr1: { name: 'Tyler Lockett', position: 3, total: 19.7 },
        wr2: { name: 'Odell Beckham Jr.', position: 3, total: 17.4 },
        rb2: { name: 'Kenyan Drake', position: 2, total: 13.22 },
        wr3: { name: 'Cole Beasley', position: 3, total: 12 },
        flex: { name: 'Golden Tate', position: 3, total: 9.7 },
        te: { name: 'Jimmy Graham', position: 4, total: 2.8 },
      },
    ],
  ...
  },
  {
    ...
    weeklyResults: [
      ...
      },
      {
        weekId: 2,
        bench: [
          { name: 'Philip Rivers', position: 1, total: 9.92 },
          { name: 'Jalen Reagor', position: 3, total: 8.100000000000001 },
          { name: 'Logan Thomas', position: 4, total: 6.6 },
          { name: 'Curtis Samuel', position: 3, total: 6.42 },
          {
            name: 'Allen Robinson II',
            position: 3,
            total: 6.300000000000001,
        ...
        wr1: { name: 'Mike Evans', position: 3, total: 23.4 },
        wr2: { name: 'DJ Moore', position: 3, total: 20 },
        wr3: { name: 'CeeDee Lamb', position: 3, total: 17.68 },
        superFlex: { name: 'Deshaun Watson', position: 1, total: 15.04 },
        rb1: { name: "D'Andre Swift", position: 2, total: 12.44 },
        flex: { name: 'JuJu Smith-Schuster', position: 3, total: 11.8 },
        rb2: {
          name: 'Devin Singletary',
          position: 2,
          total: 10.719999999999999,
        },
        te: { name: 'Dallas Goedert', position: 4, total: 7 },
      },
    ],
  ...
  },
  {
    ...
    weeklyResults: [
      ...
      },
      {
        weekId: 2,
        bench: [
          { name: 'Marquise Brown', position: 3, total: 9.2 },
          { name: 'Malcolm Brown', position: 2, total: 5.64 },
          { name: 'Sterling Shepard', position: 3, total: 5.62 },
          { name: 'Sony Michel', position: 2, total: 2.28 },
          { name: 'Derek Carr', position: 1, total: 0 },
          { name: 'Tua Tagovailoa', position: 1, total: 0 },
          { name: 'Darren Waller', position: 4, total: 0 },
        ],
        startingTotal: 169.83999999999997,
        benchTotal: 22.740000000000002,
        rb1: { name: 'Leonard Fournette', position: 2, total: 29.66 },
        wr1: { name: 'Tyreek Hill', position: 3, total: 21.98 },
        rb2: {
          name: 'Chris Carson',
          position: 2,
          total: 21.240000000000002,
        ...
        qb: { name: 'Lamar Jackson', position: 1, total: 18.64 },
        te: { name: 'Hayden Hurst', position: 4, total: 18.2 },
        wr2: { name: 'Russell Gage', position: 3, total: 16.6 },
        wr3: { name: 'Marvin Jones Jr.', position: 3, total: 12.3 },
        superFlex: { name: 'Jerry Jeudy', position: 3, total: 10.2 },
      },
    ],
    teamName: 'Team Who?',
  ...
  },
  {
    ...
    weeklyResults: [
      ...
      },
      {
        weekId: 2,
        bench: [
          { name: 'Ronald Jones II', position: 2, total: 11.16 },
          { name: 'Tevin Coleman', position: 2, total: 6.24 },
          { name: 'Julio Jones', position: 3, total: 4.4 },
          { name: 'O.J. Howard', position: 4, total: 2.1 },
        ...
        qb: { name: 'Russell Wilson', position: 1, total: 34.2 },
        rb2: { name: 'David Montgomery', position: 2, total: 23.34 },
        wr1: { name: 'DeAndre Hopkins', position: 3, total: 20.8 },
        wr2: { name: 'DK Metcalf', position: 3, total: 19.200000000000003 },
        flex: { name: 'Mark Ingram II', position: 2, total: 16.8 },
        wr3: { name: 'Brandin Cooks', position: 3, total: 14.5 },
        superFlex: { name: 'Mitchell Trubisky', position: 1, total: 13.52 },
        te: { name: 'Evan Engram', position: 4, total: 12.5 },
      },
    ],
